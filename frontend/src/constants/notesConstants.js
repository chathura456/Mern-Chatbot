...
export const NOTES_UPDATE_STATUS_REQUEST = "NOTES_UPDATE_STATUS_REQUEST";
export const NOTES_UPDATE_STATUS_SUCCESS = "NOTES_UPDATE_STATUS_SUCCESS";
export const NOTES_UPDATE_STATUS_FAIL = "NOTES_UPDATE_STATUS_FAIL";
